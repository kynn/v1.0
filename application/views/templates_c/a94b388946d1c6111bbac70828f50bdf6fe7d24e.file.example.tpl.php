<?php /* Smarty version Smarty-3.1.12, created on 2012-10-21 23:34:14
         compiled from "application\views\templates\example.tpl" */ ?>
<?php /*%%SmartyHeaderCode:123095084033a3c6e99-59447450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '123095084033a3c6e99-59447450',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5084033a5b8b68_94086328',
  'variables' => 
  array (
    'bold' => 0,
    'title' => 0,
...
<?php if ($_valid && !is_callable('content_5084033a5b8b68_94086328')) {function content_5084033a5b8b68_94086328($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include 'C:\\xampp\\htdocs\\ci\\system\\libs\\plugins\\modifier.capitalize.php';
if (!is_callable('smarty_function_ci_config')) include 'C:\\xampp\\htdocs\\ci\\system\\libs\\plugins\\function.ci_config.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:\\xampp\\htdocs\\ci\\system\\libs\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include 'C:\\xampp\\htdocs\\ci\\system\\libs\\plugins\\function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include 'C:\\xampp\\htdocs\\ci\\system\\libs\\plugins\\function.html_select_time.php';
if (!is_callable('smarty_function_ci_language')) include 'C:\\xampp\\htdocs\\ci\\system\\libs\\plugins\\function.ci_language.php';
if (!is_callable('smarty_function_ci_form_validation')) include 'C:\\xampp\\htdocs\\ci\\system\\libs\\plugins\\function.ci_form_validation.php';
if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\htdocs\\ci\\system\\libs\\plugins\\function.html_options.php';
...
<?php if (isset($_smarty_tpl->tpl_vars['message']->value)!=''){?><p class="message"><?php echo $_smarty_tpl->tpl_vars['message']->value;?>
</p><?php }?>
...
:</label>
	<select name='state'>
	<?php echo smarty_function_html_options(array('values'=>((string)$_smarty_tpl->tpl_vars['state_values']->value),'output'=>((string)$_smarty_tpl->tpl_vars['state_output']->value),'selected'=>((string)$_smarty_tpl->tpl_vars['selected_state']->value)),$_smarty_tpl);?>
